feat_cfg = [
            ...
            {'type': 'thres', 'bound': [15.0, 50.0]},                               # 年龄
            {'type': 'remove'},                               # 是否第一步粘附件
            {'type': 'remove'},                               # 是否纳7
            {'type': 'remove'},                               # 纳了几个7
            {'type': 'remove'},                               # 拔牙与否
            {'type': 'max_min_norm', 'bound': [0.0, 4.0]},                               # 拔牙个数
            {'type': 'remove'}, #'clip', 'thres': [0.0, 1.0]},                               # 是否橡皮筋牵引
            {'type': 'max_min_norm', 'bound': [0.0, 4.0]},                               # 牵引根数
            {'type': 'remove'},#'one_hot', 'num_classes': 5},                  # II类牵引2或III类3或颌内1三角4 没有表示为0
            {'type': 'remove'},                  # 前牙区牵引
            {'type': 'remove'}, #'one_hot', 'num_classes': 5},                  # 拥挤度分类
            {'type': 'remove'}, #['minus_const', 'one_hot'], 'const': 1, 'num_classes': 3},                  # 安氏分类共三类
            {'type': ['minus_const', 'one_hot'], 'const': 1, 'num_classes': 3},                  # 骨性分类共三类
            {'type': 'remove'}, #'nothing'},                  # 门牙缺失与否
            ...
            {'type': 'remove'}, #'nothing'},                  # 有无powerarm
            {'type': 'remove'},                  # PA个数
